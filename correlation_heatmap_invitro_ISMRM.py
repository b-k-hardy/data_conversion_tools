...
def hist_plot(p_cfd, estimations, model, ax):
    ...
    # math shit
    H, xedges, yedges = np.histogram2d(p_cfd, estimations, bins=26, range=[x, x])   # at some point, will probably want to double-check to make sure I'm doing this stuff correctly
    ...
    ax.set_title(fr'{model}', fontsize=18)
...
def original():
    ...
    fig, axes = plt.subplots(nrows=1, ncols=3, figsize=(12, 4), sharex=True, sharey=True, layout="constrained")
