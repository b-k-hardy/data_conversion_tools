...
def add_complex_noise(u, v, w, vel_mask, targetSNR, venc):
    ...
    # DO the downsampling
    u_noise, _ = fft.downsample_phase_img(u, mag_image, venc, 1, targetSNRdb)
    v_noise, _ = fft.downsample_phase_img(v, mag_image, venc, 1, targetSNRdb)
    w_noise, _ = fft.downsample_phase_img(w, mag_image, venc, 1, targetSNRdb)
